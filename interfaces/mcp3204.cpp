 ...
 * this function.
 * *********************************************************/
int mcp3204::spiOpen(std::string devspi){
    int statusVal = -1;
 ...
 * "data".
 * ******************************************************************/
int mcp3204::spiWriteRead( unsigned char *data, int length){
 ...
 * ***********************************************/
mcp3204::mcp3204(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ;
