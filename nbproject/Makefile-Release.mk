...
${OBJECTDIR}/interfaces/Relay.o: interfaces/Relay.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/Relay.o interfaces/Relay.cpp

${OBJECTDIR}/interfaces/digital_input.o: interfaces/digital_input.cpp
	${MKDIR} -p ${OBJECTDIR}/interfaces
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/digital_input.o interfaces/digital_input.cpp
