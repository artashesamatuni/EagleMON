...
${OBJECTDIR}/wiringPi/drcSerial.o: wiringPi/drcSerial.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/drcSerial.o wiringPi/drcSerial.c

${OBJECTDIR}/wiringPi/max31855.o: wiringPi/max31855.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/max31855.o wiringPi/max31855.c

${OBJECTDIR}/wiringPi/max5322.o: wiringPi/max5322.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/max5322.o wiringPi/max5322.c

${OBJECTDIR}/wiringPi/mcp23008.o: wiringPi/mcp23008.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp23008.o wiringPi/mcp23008.c

${OBJECTDIR}/wiringPi/mcp23016.o: wiringPi/mcp23016.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp23016.o wiringPi/mcp23016.c

${OBJECTDIR}/wiringPi/mcp23017.o: wiringPi/mcp23017.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp23017.o wiringPi/mcp23017.c

${OBJECTDIR}/wiringPi/mcp23s08.o: wiringPi/mcp23s08.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp23s08.o wiringPi/mcp23s08.c

${OBJECTDIR}/wiringPi/mcp23s17.o: wiringPi/mcp23s17.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp23s17.o wiringPi/mcp23s17.c

${OBJECTDIR}/wiringPi/mcp3002.o: wiringPi/mcp3002.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp3002.o wiringPi/mcp3002.c

${OBJECTDIR}/wiringPi/mcp3004.o: wiringPi/mcp3004.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp3004.o wiringPi/mcp3004.c

${OBJECTDIR}/wiringPi/mcp3422.o: wiringPi/mcp3422.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp3422.o wiringPi/mcp3422.c

${OBJECTDIR}/wiringPi/mcp4802.o: wiringPi/mcp4802.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/mcp4802.o wiringPi/mcp4802.c

${OBJECTDIR}/wiringPi/pcf8574.o: wiringPi/pcf8574.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/pcf8574.o wiringPi/pcf8574.c

${OBJECTDIR}/wiringPi/pcf8591.o: wiringPi/pcf8591.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/pcf8591.o wiringPi/pcf8591.c

${OBJECTDIR}/wiringPi/piHiPri.o: wiringPi/piHiPri.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/piHiPri.o wiringPi/piHiPri.c

${OBJECTDIR}/wiringPi/piThread.o: wiringPi/piThread.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/piThread.o wiringPi/piThread.c

${OBJECTDIR}/wiringPi/sn3218.o: wiringPi/sn3218.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/sn3218.o wiringPi/sn3218.c

${OBJECTDIR}/wiringPi/softPwm.o: wiringPi/softPwm.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/softPwm.o wiringPi/softPwm.c

${OBJECTDIR}/wiringPi/softServo.o: wiringPi/softServo.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/softServo.o wiringPi/softServo.c

${OBJECTDIR}/wiringPi/softTone.o: wiringPi/softTone.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/softTone.o wiringPi/softTone.c

${OBJECTDIR}/wiringPi/sr595.o: wiringPi/sr595.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/sr595.o wiringPi/sr595.c

${OBJECTDIR}/wiringPi/wiringPi.o: wiringPi/wiringPi.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/wiringPi.o wiringPi/wiringPi.c

${OBJECTDIR}/wiringPi/wiringPiI2C.o: wiringPi/wiringPiI2C.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/wiringPiI2C.o wiringPi/wiringPiI2C.c

${OBJECTDIR}/wiringPi/wiringPiSPI.o: wiringPi/wiringPiSPI.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/wiringPiSPI.o wiringPi/wiringPiSPI.c

${OBJECTDIR}/wiringPi/wiringSerial.o: wiringPi/wiringSerial.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/wiringSerial.o wiringPi/wiringSerial.c

${OBJECTDIR}/wiringPi/wiringShift.o: wiringPi/wiringShift.c
	${MKDIR} -p ${OBJECTDIR}/wiringPi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wiringPi/wiringShift.o wiringPi/wiringShift.c
